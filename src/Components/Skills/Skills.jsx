      ...
      <div className="flex flex-col lg:flex-row-reverse justify-center  items-center gap-5">
        ...
        <div>
          <h3 className="text-xl lg:text-3xl">
            Here are some skill that I am proficient with{" "}
          </h3>
          <div>
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 text-center">
              ...
              <div className="bg-gray-200 rounded-md shadow-xl p-5 mx-auto my-3">
                <SiNetlify className="text-6xl text-blue-500" />
                <p className="text-center mt-3">Netlify</p>
              </div>
              <div className="bg-gray-200 rounded-md shadow-xl p-5 mx-auto my-3">
                <SiDaisyui className="text-6xl " />
                <p className="text-center mt-3">DaisyUi</p>
              </div>
            </div>
          </div>
        </div>
